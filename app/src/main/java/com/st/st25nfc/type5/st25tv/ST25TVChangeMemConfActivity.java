...
public class ST25TVChangeMemConfActivity extends STFragmentActivity implements STType5PwdDialogFragment.STType5PwdDialogListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        configurationPasswordNumber = UIHelper.getConfigurationPasswordNumber(nfcTag);
    ...
    private void getCurrentMemoryConf() {
        new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    isMemoryConfiguredInSingleArea = (mMultiAreaInterface.getNumberOfAreas() > 1) ? false : true;
            ...
            public void run() {
                ...
                try {
                    if (singleAreaRadioButton.isChecked()) {
                        mMultiAreaInterface.setNumberOfAreas(1);
                    } else {
                        mMultiAreaInterface.setNumberOfAreas(2);
                    }
